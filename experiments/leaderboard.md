...
| `fact_B+C+E` | Factorial (B+C+E) | 3.2850 | **3.2881** | +0.0031 | 26.79 | 948 tok/s | 9067.2 |
...
| `fact_A+B+C+E` | Factorial (A+B+C+E) | 3.2874 | **3.2889** | +0.0014 | 26.81 | 1442 tok/s | 8959.6 |
...
| `fact_A+B+C` | Factorial (A+B+C) | 3.2881 | **3.2895** | +0.0014 | 26.83 | 2861 tok/s | 9048.2 |
